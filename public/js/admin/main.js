$(function(){
	...
	********************************************************************************/
	...
	$('.multi_language_expand').on('click',(function()
	{
...
//	});
	...
	$('.table_all_form .ask-all-form a').on('click',function(){
		opencolorbox($(this));
		return false;
	});
...
$(document).ready(function()
{
	...
	$('#main-content .content-box .content-box-header .content-box-tabs li').on('click',(function(){
		if(!$(this).children('a').hasClass('current'))
		{
		 	var href = $(this).children('a').attr('href');
	...
	$('.table_all_form tbody tr td a.help-for-button[name="button_edit"]').on('click',(function(){
	...
	$('#form_button_bar #submitform.button').on('click',(function(){
